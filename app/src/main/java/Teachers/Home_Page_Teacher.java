...
public class Home_Page_Teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home__page__teacher);
        // ẨN ACTIONBAR
        ...
        managerclass = findViewById(R.id.managerclass);
        ...
        managerclass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Home_Page_Teacher.this, ManagerClass.class);
        ...
        changeinformation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Home_Page_Teacher.this, ChangeInformationTeacher.class);
                it.putExtra("username",username);
                startActivity(it);
            }
        });
        changepassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Home_Page_Teacher.this, ChangePasswordAccount.class);
                startActivity(it);
            }
        });
    }
    private void logoutsystem() {
        ...
        btnout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toast.show();
                //END
                Intent it = new Intent(Home_Page_Teacher.this, Login.class);
                startActivity(it);
                finish();
            }
        });
