...
public class Home_Page_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home__page__admin);
        ...
        managerclass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Home_Page_Admin.this, Index_Admin.class);
        ...
        changepassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Home_Page_Admin.this, ChangePasswordAccount.class);
                startActivity(it);
            }
        });
    }
    private void logoutsystem() {
        ...
        btnout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toast.show();
                //END
                Intent it = new Intent(Home_Page_Admin.this, Login.class);
                startActivity(it);
                finish();
            }
        });
